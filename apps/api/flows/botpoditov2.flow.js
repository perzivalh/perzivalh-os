...
module.exports = {
  ...
  nodes: [
    ...
    },
    {
      ...
      type: "text",
      text:
        "Con una correcta extracción del uñero, puedes disfrutar de una rutina diaria más tranquila y cómoda ??????????\nOlvídate del dolor, la inflamación y las molestias, y vuelve a caminar con total bienestar ????",
      next: "UNERO_INFO_5",
    },
    {
      id: "UNERO_INFO_5",
      ...
      text:
        "Si necesita un paquete completo ??? tiene una opción accesible y detallada por realizarse, PODOMIX incluye una valoración profesional ???????, extracción de uñeros ???? y pedicure clínico ????, todo por un costo de 300 Bs ??.\nEste paquete se realiza únicamente bajo recomendación del especialista ??, ya que durante la valoración ?? se determinará si el paciente necesita o no dicho tratamiento ??.",
    ...
    },
    {
      ...
      type: "text",
      text:
        "Recuerda que cada caso es único, por eso te invitamos a una evaluación personalizada con nuestros especialistas ????????????",
    ...
    },
    {
      ...
      text:
        "Si en la consulta se detecta la necesidad de tratar UÑEROS, FISURAS, VERRUGAS, HONGOS E HIPERQUERATOSIS el precio variará según el servicio a realizar, así usted decide si desea el SERVICIO ADICIONAL en ese momento. ????????????",
    ...
    },
    {
      ...
      text:
        "Si necesita un paquete completo ??? tiene una opción accesible y detallada por realizarse, PODOCALLOS incluye una valoración profesional ???????, pedicure clínico ????, tratamiento y limpieza de callosidades, todo por un costo de 200 Bs ??.\nEste paquete se realiza únicamente bajo recomendación del especialista ??, ya que durante la valoración ?? se determinará si el paciente necesita o no dicho tratamiento ??.",
    ...
    },
    {
      ...
      text:
        "Un heloma es una lesión en la piel del pie ??, conocida comúnmente como callo, que se forma por presión o fricción constante ????. Se caracteriza por un engrosamiento de la piel ?? y puede causar dolor ??, especialmente al caminar ????? o al usar calzado ajustado ??. Suele aparecer en la planta del pie ?? o en los dedos ???.\nEl tratamiento de heloma consiste en la eliminación segura del callo, alivio del dolor, y recomendaciones personalizadas para evitar que reaparezca ???\nEl consto del tratamiento tiene un valor de 100 Bs.",
