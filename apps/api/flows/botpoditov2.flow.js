...
module.exports = {
  ...
  nodes: [
    ...
    },
    {
      ...
      text: " ",
      next: "HORARIOS_CENTRAL_MAP_TEXT",
    },
    {
      id: "HORARIOS_CENTRAL_MAP_TEXT",
      type: "text",
      text:
        "Haz clic aquí para ver nuestra ubicación en Google Maps:\nhttps://maps.app.goo.gl/eXTejzQhp8zm3EmT8",
      next: "HORARIOS_CENTRAL_MAP_IMG",
    },
    {
      id: "HORARIOS_CENTRAL_MAP_IMG",
      type: "image",
      url: "https://pub-d02cc32ec9504df3a4d645e1520c6f43.r2.dev/media/centralUbicacion.jpg",
      text: " ",
      next: "HORARIOS_CENTRAL_LINES_TEXT",
    },
    {
      id: "HORARIOS_CENTRAL_LINES_TEXT",
      type: "text",
      text: "🚌 Líneas que pasan: 74, 38, 7, 60, 51, 36, 37, 89, Trufi",
      next: "HORARIOS_CENTRAL_LINES_IMG",
    },
    {
      id: "HORARIOS_CENTRAL_LINES_IMG",
      type: "image",
      url: "https://pub-d02cc32ec9504df3a4d645e1520c6f43.r2.dev/media/centralLineas.jpg",
      text: " ",
      next: "HORARIOS_CENTRAL_VIDEO_TEXT",
    },
    {
      id: "HORARIOS_CENTRAL_VIDEO_TEXT",
      type: "text",
      text: "▶️ Mediante este video puedes encontrar la central de PODOPIE 📌⬆️",
    ...
    },
    {
      ...
      text: " ",
      next: "HORARIOS_SUCURSAL_HORARIO_TEXT",
    },
    {
      id: "HORARIOS_SUCURSAL_HORARIO_TEXT",
      type: "text",
    ...
    },
    {
      ...
      text: " ",
      next: "HORARIOS_SUCURSAL_MAP_TEXT",
    },
    {
      id: "HORARIOS_SUCURSAL_MAP_TEXT",
      type: "text",
      text:
        "Haz clic aquí para ver nuestra ubicación en Google Maps:\nhttps://maps.app.goo.gl/eXTejzQhp8zm3EmT8",
      next: "HORARIOS_SUCURSAL_MAP_IMG",
    },
    {
      id: "HORARIOS_SUCURSAL_MAP_IMG",
      type: "image",
      url: "https://pub-d02cc32ec9504df3a4d645e1520c6f43.r2.dev/media/sucursalUbicacion.jpg",
      text: " ",
      next: "HORARIOS_SUCURSAL_LINES_TEXT",
    },
    {
      id: "HORARIOS_SUCURSAL_LINES_TEXT",
      type: "text",
      text: "🚌 Líneas que pasan: 74, 38, 7, 60, 51, 36, 37, 89, Trufi",
      next: "HORARIOS_SUCURSAL_LINES_IMG",
    },
    {
      id: "HORARIOS_SUCURSAL_LINES_IMG",
      type: "image",
      url: "https://pub-d02cc32ec9504df3a4d645e1520c6f43.r2.dev/media/sucursalLineas.jpg",
      text: " ",
      next: "HORARIOS_SUCURSAL_VIDEO_TEXT",
    },
    {
      id: "HORARIOS_SUCURSAL_VIDEO_TEXT",
      type: "text",
      text: "▶️ Mediante este video puedes encontrar la sucursal de PODOPIE 📌⬆️",
