...
module.exports = {
  ...
  ai: {
    ...
    "deterministic_intents": [
      ...
      { "routeId": "CONTACT_METHOD",    "intent": "contact",        "phrases": ["asesor", "asesora", "humano", "operador", "operadora", "agente", "recepcion", "persona real", "atencion personal", "atencion personalizada", "atencion humana", "hablar con alguien", "hablar con una persona", "hablar con un operador", "hablar con una operadora", "quiero hablar con un operador", "quiero hablar con una operadora", "llamar"] },
      ...
      { "routeId": "DOCTOR_HANDOFF", "intent": "doctor", "phrases": ["doctor", "doctora", "dr", "dra", "medico", "medica", "que doctor", "que doctora", "con que doctor", "con que doctora", "quien me atiende", "con quien me atiendo", "nombre del doctor", "nombre de la doctora", "esta el doctor", "esta la doctora", "esta el dr", "esta la dra", "se encuentra el doctor", "se encuentra la doctora", "hay doctor", "hay doctora", "doctor disponible", "doctora disponible", "me atiende algun doctor"] }
    ],
    ...
    // --- Mapa keyword → nodeId (fallback de último recurso cuando la IA falla) ---
    // IMPORTANTE: todas las claves deben estar sin tildes (normalizeText elimina tildes del input
    // pero NO normaliza las claves, por lo que claves con tildes nunca coinciden).
    "keyword_routes": {
      "hola": "MAIN_MENU",
      "buenas": "MAIN_MENU",
      ...
      "operador": "CONTACT_METHOD",
      "operadora": "CONTACT_METHOD",
      "agente": "CONTACT_METHOD",
      ...
      "hablar con un operador": "CONTACT_METHOD",
      "hablar con una operadora": "CONTACT_METHOD",
      "quiero hablar con un operador": "CONTACT_METHOD",
      "quiero hablar con una operadora": "CONTACT_METHOD",
      ...
      "con que doctora": "DOCTOR_HANDOFF",
      "nombre del doctor": "DOCTOR_HANDOFF",
      "nombre de la doctora": "DOCTOR_HANDOFF",
      "quien me atiende": "DOCTOR_HANDOFF",
      "con quien me atiendo": "DOCTOR_HANDOFF",
      "esta el doctor": "DOCTOR_HANDOFF",
      "esta la doctora": "DOCTOR_HANDOFF",
      "esta el dr": "DOCTOR_HANDOFF",
      "esta la dra": "DOCTOR_HANDOFF",
      "se encuentra el doctor": "DOCTOR_HANDOFF",
      "se encuentra la doctora": "DOCTOR_HANDOFF",
      "hay doctor": "DOCTOR_HANDOFF",
      "hay doctora": "DOCTOR_HANDOFF",
      "doctor disponible": "DOCTOR_HANDOFF",
      "doctora disponible": "DOCTOR_HANDOFF",
      "me atiende algun doctor": "DOCTOR_HANDOFF",
  ...
  nodes: [
    ...
    },
    {
      ...
      "text": "Uñero es una inflamación que se produce cuando una uña crece de forma anormal y se clava en la piel que la rodea, causando dolor, enrojecimiento e hinchazón.",
      "next": "UNERO_INFO_2"
    },
    {
      "id": "UNERO_INFO_2",
    ...
    },
    {
      "id": "HONGOS_PACK_NOTE",
      "type": "text",
      "text": "Estos paquetes se realizan únicamente bajo recomendación del especialista 🩺, ya que durante la valoración 🔍 se determinará si el paciente necesita o no dicho tratamiento ✅❌.",
    ...
    },
    {
      ...
      "text": "El pie de atleta es una infección causada por hongos que afecta principalmente la piel de los pies, sobre todo entre los dedos. Es una afección bastante común y contagiosa, que suele aparecer cuando los pies permanecen húmedos y calientes por mucho tiempo, como al usar zapatos cerrados durante horas.",
    ...
    },
    {
      ...
      "type": "text",
      "text": "📄 Aquí tienes un resumen con precios y servicios por si quieres guardarlo o compartirlo.",
    ...
    },
    {
      ...
      "type": "text",
      "text": "Agradecemos sinceramente su confianza 🤝. Quedamos a su disposición para atender cualquier necesidad o inconveniente podológico que pudiera presentarse 🦶✨. Saludos.",
      "terminal": true
    },
    {
      "id": "CIERRE_HORARIO_UBICACION",
      "type": "text",
      "text": "¡Gracias por contactarnos! 🙏 Aquí te dejamos nuestros horarios y ubicación por si nos necesitas.",
